...
INFLUX_ORG="${INFLUX_ORG:-speedtest}"
INFLUX_BUCKET="${INFLUX_BUCKET:-speedtest}"
...
run_speedtest()
{
    ...
    then
        ...
        curl -s -S -XPOST "$DB_HOST/api/v2/write?org=$INFLUX_ORG&bucket=$INFLUX_BUCKET&precision=s" \
